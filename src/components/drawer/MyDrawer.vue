...
<template>
    ...
    <div class="bg-white w-96 h-full fixed right-0 top-0 z-20 p-8">
       ...
       <div class="flex flex-col gap-5 mt-7">
        ...
        <button class="mt-4 bg-lime-500 w-full rounded-xl py-3 disabled:bg-slate-400 text-white hover:bg-lime-600 transition cursor-pointer active:bg-lime-700">Buy</button>
       </div>
    </div>
</template>